...
def setup_window_colors():
    ...
    nc.init_pair(WC_FILE, nc.COLOR_CYAN, WC_BG_DEFAULT)
    ...
    nc.init_pair(WC_FILE_2, nc.COLOR_CYAN, WC_BG_DEFAULT_2)
    ...
    nc.init_pair(WC_HIGHLIGHT_FILE, nc.COLOR_CYAN, WC_BG_HIGHLIGHT)
